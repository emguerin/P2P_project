...
public class HashServer implements Server {

	@Override
	public static void recoitDemandeDeCommunication(int portNumber, int circleSize) {
		...
		try (
		    ...
		    System.out.println("Message de HashServer : lancé");
    ...
    public static void main(String[] args) throws IOException {
		...
		HashServer.recoitDemandeDeCommunication(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
	}
}
